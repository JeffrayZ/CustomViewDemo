package com.example.nestedscrollviewdemo.demo1;
...
public class MyNestedScrollLayout1 extends LinearLayoutCompat implements NestedScrollingParent3 {
//    private RecyclerView

    public MyNestedScrollLayout1(Context context) {
        super(context);
    }

    public MyNestedScrollLayout1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyNestedScrollLayout1(Context context, AttributeSet attrs, int defStyleAttr) {
