...
public class NestedScrollingParent2View extends LinearLayout implements NestedScrollingParent2 {
    ...
    public NestedScrollingParent2View(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public NestedScrollingParent2View(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public NestedScrollingParent2View(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void onNestedPreScroll(@NonNull View target, int dx, int dy, @NonNull int[] consumed, int type) {
        //自己处理逻辑
        Log.e("onNestedPreScroll",target+"::"+dx+"::"+dy+"::"+ Arrays.toString(consumed) +"::"+type);
    }
